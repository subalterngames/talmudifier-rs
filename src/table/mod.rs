...
impl Table {
    ...
    pub fn get_width(&self, position: &Position) -> Width {
        match (self, position) {
            (Self::One, _) => Width::One,
            (Self::LeftRight, Position::Left) | (Self::LeftRight, Position::Right) => Width::Half,
            (Self::LeftCenter, Position::Left)
            | (Self::Three, _)
            | (Self::CenterRight, Position::Right) => Width::Third,
            (Self::LeftCenter, Position::Center) | (Self::CenterRight, Position::Center) => {
                Width::TwoThirds
            }
